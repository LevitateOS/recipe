mod http_tests {
    use crate::helpers::acquire::http::api::get_http_timeout;
    use crate::helpers::acquire::{
        github_latest_release, github_latest_tag, http_get, parse_version,
    };
    ...
    mod mock_tests {
        use crate::helpers::acquire::http::api::{
            github_latest_release_with_base, github_latest_tag_with_base,
        };
        use crate::helpers::acquire::http_get;
