//! # Recipe Lifecycle - Design Philosophy
//!
//! ## The Core Invariant
//!
...
//!
//! Separation enables caching:
//! - Re-build without re-acquiring
//! - Re-install without rebuilding
//! - Each phase independently cacheable
//!
//! ## Anti-Pattern: Monolithic Functions
//!
//! DO NOT create functions that combine phases. This defeats caching
//! and violates the core design. If you're tempted to put everything
//! in one function "to make it work" - STOP. That's reward hacking.
//!
